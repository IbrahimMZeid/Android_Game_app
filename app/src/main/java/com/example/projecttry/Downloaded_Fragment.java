 ...
 * Use the {@link Downloaded_Fragment#newInstance} factory method to
...
public class Downloaded_Fragment extends Fragment {
    ...
    public static Downloaded_Fragment newInstance(String param1, String param2) {
        Downloaded_Fragment fragment = new Downloaded_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        downloadedRV = view.findViewById(R.id.idRVDownloaded);

        FavouriteRVAdapter adapter = new FavouriteRVAdapter(homeRVModelArrayList, getActivity());
        GridLayoutManager layoutManager = new GridLayoutManager(getActivity(), 2);
        downloadedRV.setLayoutManager(layoutManager);
        downloadedRV.setAdapter(adapter);
    ...
    public void getGames() {
        ...
        if (games != null) {
            for (int i = 0; i < games.size(); i++) {
                intent = getActivity().getPackageManager().getLaunchIntentForPackage(games.get(i).getState());
                if (intent != null) {
